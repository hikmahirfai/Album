document.addEventListener('DOMContentLoaded', () => {
    ...
    const lyrics = [
        { time: 0, text: "Inilah Aku Yang Memilih Kau Untukku" },
        { time: 11, text: "Kar'na Aku Mencintaimu" },
        { time: 18, text: "Dan Hatiku Hanya Untukmu" },
        { time: 24, text: "Tak Akan Menyerah" },
        { time: 27, text: "Dan Takkan Berhenti Mencintaimu" },
        { time: 37, text: "Ku Berjuang Dalam Hidupku" },
        { time: 43, text: "Untuk S'lalu Memilikimu" },
        { time: 50, text: "Seumur Hidupku, Setulus Hatiku" },
        { time: 57, text: "Hanya Untukmu" },
        { time: 59, text: "....." },
    ];
